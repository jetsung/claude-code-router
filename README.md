...
- 使用项目提供的 Docker 镜像
    ...
    | Registry                                                                                   | Image                                                  |
    | ------------------------------------------------------------------------------------------ | ------------------------------------------------------ |
    | [**Docker Hub**](https://hub.docker.com/r/jetsung/claude-code-router/)                                | `jetsung/claude-code-router`                                    |
    | [**GitHub Container Registry**](https://github.com/jetsung/claude-code-router/pkgs/container/claude-code-router) | `ghcr.io/jetsung/claude-code-router`                            |
